...
{
    class LC_A_QueriesOnAPermutationWithKey
    {
        // ---------------------------------------- Problem ----------------------------------------
        ...
        //Console.WriteLine(string.Join(", ", ProcessQueries(new[] { 3, 1, 2, 1 }, 5))); // [2, 1, 2, 1]
        //Console.WriteLine(string.Join(", ", ProcessQueries(new[] { 4, 1, 2, 2 }, 4))); // [3, 1, 2, 0]
        //Console.WriteLine(string.Join(", ", ProcessQueries(new[] { 7, 5, 5, 8, 3 }, 8))); // [6, 5, 0, 7, 5]
        ...
        public int[] ProcessQueries232(int[] queries, int m)
        {
